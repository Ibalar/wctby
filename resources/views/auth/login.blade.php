...
<main class="content-wrapper w-100 px-3 ps-lg-5 pe-lg-4 mx-auto" style="max-width: 1920px">
    <div class="d-lg-flex">
        ...
        <div class="d-flex flex-column min-vh-100 w-100 py-4 mx-auto me-lg-5" style="max-width: 416px">
            ...
            <h1 class="h2 mt-auto">Добро пожаловать</h1>
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="nav">
                        <a class="nav-link animate-underline p-0" href="{{ route('password.request') }}">
                            <span class="animate-target">Забыли пароль?</span>
                        </a>
                    </div>
                </div>
                ...
                @foreach(config('social_auth.providers', []) as $provider => $meta)
                    <a href="{{ route('social.redirect', $provider) }}"
                       class="btn btn-lg btn-outline-secondary w-100 px-2">
                        <i class="{{ $meta['icon'] ?? 'ci-link' }} ms-1 me-1"></i>
        ...
        <div class="d-none d-lg-block w-100 py-4 ms-auto" style="max-width: 1034px">
            <div class="d-flex flex-column justify-content-end h-100 rounded-5 overflow-hidden">
                ...
                <div class="ratio position-relative z-2" style="--cz-aspect-ratio: calc(1030 / 1032 * 100%)">
                    <img src="{{ asset('assets/img/account/cover.png') }}" alt="Cover">
                </div>
