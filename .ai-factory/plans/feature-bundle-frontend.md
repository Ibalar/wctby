...
- [ ] **Задача 1: BundleController + роуты + Blade-шаблоны**
...
- [ ] **Задача 2: Интеграция бандлов в корзину**
...
- [ ] **Задача 3: MoonShine-полировка Index и Detail страниц**
...
- [ ] **Задача 5: Добавить бандлы в главную страницу**
