...
- [x] **Задача 3: Создать EventServiceProvider**
...
### Фаза 2: Слушатели
- [x] **Задача 4: Создать ClearCart listener**
...
- [x] **Задача 5: Создать SendOrderConfirmation listener**
...
- [x] **Задача 6: Создать SendNewOrderAdminNotification listener**
...
- [x] **Задача 7: Создать SendOrderStatusChangedNotification listener**
...
### Фаза 3: Интеграция
- [x] **Задача 8: Обновить CheckoutController — dispatch OrderCreated**
...
- [x] **Задача 9: Обновить Order::transitionTo() — dispatch OrderStatusChanged**
...
### Фаза 4: Тесты
- [x] **Задача 10: Тесты событий и слушателей**
