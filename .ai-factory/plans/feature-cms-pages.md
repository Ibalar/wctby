...
- [ ] **Задача 1: Контроллер, роут и Blade-шаблон для публичной страницы**
...
- [ ] **Задача 2: Фабрика и feature-тест для PageController**
...
- [ ] **Задача 3: MoonShine-ресурс Page (4 файла)**
...
- [ ] **Задача 4: Регистрация PageResource в MoonShineServiceProvider**
...
- [ ] **Задача 5: Метод forPage() в BreadcrumbService**
